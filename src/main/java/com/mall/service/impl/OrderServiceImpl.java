...
public class OrderServiceImpl implements IOrderService {
    ...
    private ServerResponse getCartOrderItem(Integer userId, List<Cart> cartList) {
        ...
        for (Cart cartItem : cartList) {
            ...
            if (Constant.ProductStatusEnum.ON_SALE.getCode() != product.getStatus()) {
                return ServerResponse.createByErrorMessage("产品" + product.getName() + "已经下架，无法进行购买");
            }
    ...
    public ServerResponse<String> cancel(Integer userId, Long orderNo) {
        ...
        if (null == order) {
            return ServerResponse.createByErrorMessage("该用户此没有此订单");
        }
    ...
    public ServerResponse pay(Long orderNo, Integer userId, String path) {
        ...
        Order order = orderMapper.selectByUserIdAndOrderNo(userId, orderNo);
        if (order == null) {
            return ServerResponse.createByErrorMessage("用户未提交该订单");
        }
        ...
        String subject = new StringBuilder().append("网易商城扫码支付,订单号:").append(outTradeNo).toString();
    ...
    public ServerResponse aliCallback(Map<String, String> params) {
        ...
        if (null == order) {
            return ServerResponse.createByErrorMessage("非对应的订单，忽略此次回调");
        }
